...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.print(productsArray);
  }
  ...
  public static void print(ArrayList<Product> productArray2) {
    for (int i = 1; i < productArray2.size(); i++) {
      System.out.println(productArray2.get(i).getClass());
    }
  }
}
